...
_lr_signature = '\xa0\x8e]\xcc\xac\xe2\xcfC\x92\xf3\x81kJ\xd3Di'
...
_lr_productions = [
  ...
  ('programa -> declaracion TkExecute instlist TkDone','programa',4,'p_programa','./ContBrainiac.py',365),
  ('programa -> TkExecute instlist TkDone','programa',3,'p_programa','./ContBrainiac.py',366),
  ('term -> TkNum','term',1,'p_term_num','./ContBrainiac.py',375),
  ('term -> TkIdent','term',1,'p_term_ident','./ContBrainiac.py',383),
  ('exp_un -> TkResta exp','exp_un',2,'p_exp_un','./ContBrainiac.py',391),
  ('exp_un -> TkNegacion exp','exp_un',2,'p_exp_un','./ContBrainiac.py',392),
  ('exp_un -> TkInspeccion exp','exp_un',2,'p_exp_un','./ContBrainiac.py',393),
  ('exp -> term','exp',1,'p_exp','./ContBrainiac.py',399),
  ('exp -> exp_un','exp',1,'p_exp','./ContBrainiac.py',400),
  ('exp -> TkParAbre exp TkParCierra','exp',3,'p_exp','./ContBrainiac.py',401),
  ('exp -> TkCorcheteAbre exp TkCorcheteCierra','exp',3,'p_exp','./ContBrainiac.py',402),
  ('exp -> TkLlaveAbre exp TkLlaveCierra','exp',3,'p_exp','./ContBrainiac.py',403),
  ('exp -> exp TkMas exp','exp',3,'p_exp','./ContBrainiac.py',404),
  ('exp -> exp TkMult exp','exp',3,'p_exp','./ContBrainiac.py',405),
  ('exp -> exp TkMod exp','exp',3,'p_exp','./ContBrainiac.py',406),
  ('exp -> exp TkDiv exp','exp',3,'p_exp','./ContBrainiac.py',407),
  ('exp -> exp TkResta exp','exp',3,'p_exp','./ContBrainiac.py',408),
  ('exp -> TkTrue','exp',1,'p_exp','./ContBrainiac.py',409),
  ('exp -> TkFalse','exp',1,'p_exp','./ContBrainiac.py',410),
  ('exp -> exp TkIgual exp','exp',3,'p_exp','./ContBrainiac.py',411),
  ('exp -> exp TkDesigual exp','exp',3,'p_exp','./ContBrainiac.py',412),
  ('exp -> exp TkMenor exp','exp',3,'p_exp','./ContBrainiac.py',413),
  ('exp -> exp TkMayor exp','exp',3,'p_exp','./ContBrainiac.py',414),
  ('exp -> exp TkMenorIgual exp','exp',3,'p_exp','./ContBrainiac.py',415),
  ('exp -> exp TkMayorIgual exp','exp',3,'p_exp','./ContBrainiac.py',416),
  ('exp -> exp TkDisyuncion exp','exp',3,'p_exp','./ContBrainiac.py',417),
  ('exp -> exp TkConjuncion exp','exp',3,'p_exp','./ContBrainiac.py',418),
  ('exp -> exp TkConcat exp','exp',3,'p_exp','./ContBrainiac.py',419),
  ('instruccion -> TkIdent TkAsignacion exp','instruccion',3,'p_instruccion_asignacion','./ContBrainiac.py',431),
  ('instruccion -> TkRead exp','instruccion',2,'p_instruccion_read','./ContBrainiac.py',437),
  ('instruccion -> TkWrite exp','instruccion',2,'p_instruccion_write','./ContBrainiac.py',443),
  ('instruccion -> TkWhile exp TkDo instlist TkDone','instruccion',5,'p_instruccion_while','./ContBrainiac.py',449),
  ('instruccion -> TkFor TkIdent TkFrom exp TkTo exp TkDo instlist TkDone','instruccion',9,'p_instruccion_for','./ContBrainiac.py',455),
  ('instruccion -> TkIf exp TkThen instlist TkDone','instruccion',5,'p_instruccion_if','./ContBrainiac.py',460),
  ('instruccion -> TkIf exp TkThen instlist TkElse instlist TkDone','instruccion',7,'p_instruccion_if','./ContBrainiac.py',461),
  ('instruccion -> declaracion TkExecute instlist TkDone','instruccion',4,'p_instruccion_bloque','./ContBrainiac.py',470),
  ('instruccion -> TkExecute instlist TkDone','instruccion',3,'p_instruccion_bloque','./ContBrainiac.py',471),
  ('instruccion -> TkLlaveAbre lista_tape TkLlaveCierra TkAt ident_tape','instruccion',5,'p_instruccion_b','./ContBrainiac.py',480),
  ('ident_tape -> TkCorcheteAbre exp TkCorcheteCierra','ident_tape',3,'p_ident_tape','./ContBrainiac.py',484),
  ('ident_tape -> TkIdent','ident_tape',1,'p_ident_tape','./ContBrainiac.py',485),
  ('lista_tape -> lista_tape simb_tape','lista_tape',2,'p_lista_tape','./ContBrainiac.py',494),
  ('lista_tape -> simb_tape','lista_tape',1,'p_lista_tape','./ContBrainiac.py',495),
  ('simb_tape -> TkPunto','simb_tape',1,'p_simb_tape','./ContBrainiac.py',504),
  ('simb_tape -> TkMayor','simb_tape',1,'p_simb_tape','./ContBrainiac.py',505),
  ('simb_tape -> TkMenor','simb_tape',1,'p_simb_tape','./ContBrainiac.py',506),
  ('simb_tape -> TkMas','simb_tape',1,'p_simb_tape','./ContBrainiac.py',507),
  ('simb_tape -> TkResta','simb_tape',1,'p_simb_tape','./ContBrainiac.py',508),
  ('simb_tape -> TkComa','simb_tape',1,'p_simb_tape','./ContBrainiac.py',509),
  ('instlist -> instlist semicoloninst','instlist',2,'p_instlist','./ContBrainiac.py',515),
  ('instlist -> instruccion','instlist',1,'p_instlist','./ContBrainiac.py',516),
  ('semicoloninst -> TkPuntoYComa instruccion','semicoloninst',2,'p_commainst','./ContBrainiac.py',525),
  ('declaracion -> TkDeclare declist','declaracion',2,'p_declaracion','./ContBrainiac.py',531),
  ('declist -> dec TkPuntoYComa declist','declist',3,'p_declist','./ContBrainiac.py',537),
  ('declist -> dec','declist',1,'p_declist','./ContBrainiac.py',538),
  ('dec -> varlist TkType tipo','dec',3,'p_dec','./ContBrainiac.py',546),
  ('varlist -> TkIdent TkComa varlist','varlist',3,'p_varlist','./ContBrainiac.py',552),
  ('varlist -> TkIdent','varlist',1,'p_varlist','./ContBrainiac.py',553),
  ('tipo -> TkInteger','tipo',1,'p_tipo','./ContBrainiac.py',564),
  ('tipo -> TkBoolean','tipo',1,'p_tipo','./ContBrainiac.py',565),
  ('tipo -> TkTape','tipo',1,'p_tipo','./ContBrainiac.py',566),
]
