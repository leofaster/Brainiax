...
_lr_productions = [
  ...
  ('programa -> declaracion TkExecute instlist TkDone','programa',4,'p_programa','./SintBrainiac.py',580),
  ('programa -> TkExecute instlist TkDone','programa',3,'p_programa','./SintBrainiac.py',581),
  ('term -> TkNum','term',1,'p_term_num','./SintBrainiac.py',590),
  ('term -> TkIdent','term',1,'p_term_ident','./SintBrainiac.py',598),
  ('exp_un -> TkResta exp','exp_un',2,'p_exp_un','./SintBrainiac.py',606),
  ('exp_un -> TkNegacion exp','exp_un',2,'p_exp_un','./SintBrainiac.py',607),
  ('exp_un -> TkInspeccion exp','exp_un',2,'p_exp_un','./SintBrainiac.py',608),
  ('exp -> term','exp',1,'p_exp','./SintBrainiac.py',614),
  ('exp -> exp_un','exp',1,'p_exp','./SintBrainiac.py',615),
  ('exp -> TkParAbre exp TkParCierra','exp',3,'p_exp','./SintBrainiac.py',616),
  ('exp -> TkCorcheteAbre exp TkCorcheteCierra','exp',3,'p_exp','./SintBrainiac.py',617),
  ('exp -> TkLlaveAbre exp TkLlaveCierra','exp',3,'p_exp','./SintBrainiac.py',618),
  ('exp -> exp TkMas exp','exp',3,'p_exp','./SintBrainiac.py',619),
  ('exp -> exp TkMult exp','exp',3,'p_exp','./SintBrainiac.py',620),
  ('exp -> exp TkMod exp','exp',3,'p_exp','./SintBrainiac.py',621),
  ('exp -> exp TkDiv exp','exp',3,'p_exp','./SintBrainiac.py',622),
  ('exp -> exp TkResta exp','exp',3,'p_exp','./SintBrainiac.py',623),
  ('exp -> TkTrue','exp',1,'p_exp','./SintBrainiac.py',624),
  ('exp -> TkFalse','exp',1,'p_exp','./SintBrainiac.py',625),
  ('exp -> exp TkIgual exp','exp',3,'p_exp','./SintBrainiac.py',626),
  ('exp -> exp TkDesigual exp','exp',3,'p_exp','./SintBrainiac.py',627),
  ('exp -> exp TkMenor exp','exp',3,'p_exp','./SintBrainiac.py',628),
  ('exp -> exp TkMayor exp','exp',3,'p_exp','./SintBrainiac.py',629),
  ('exp -> exp TkMenorIgual exp','exp',3,'p_exp','./SintBrainiac.py',630),
  ('exp -> exp TkMayorIgual exp','exp',3,'p_exp','./SintBrainiac.py',631),
  ('exp -> exp TkDisyuncion exp','exp',3,'p_exp','./SintBrainiac.py',632),
  ('exp -> exp TkConjuncion exp','exp',3,'p_exp','./SintBrainiac.py',633),
  ('exp -> exp TkConcat exp','exp',3,'p_exp','./SintBrainiac.py',634),
  ('instruccion -> TkIdent TkAsignacion exp','instruccion',3,'p_instruccion_asignacion','./SintBrainiac.py',646),
  ('instruccion -> TkRead exp','instruccion',2,'p_instruccion_read','./SintBrainiac.py',652),
  ('instruccion -> TkWrite exp','instruccion',2,'p_instruccion_write','./SintBrainiac.py',658),
  ('instruccion -> TkWhile exp TkDo instlist TkDone','instruccion',5,'p_instruccion_while','./SintBrainiac.py',664),
  ('instruccion -> TkFor TkIdent TkFrom exp TkTo exp TkDo instlist TkDone','instruccion',9,'p_instruccion_for','./SintBrainiac.py',670),
  ('instruccion -> TkIf exp TkThen instlist TkDone','instruccion',5,'p_instruccion_if','./SintBrainiac.py',676),
  ('instruccion -> TkIf exp TkThen instlist TkElse instlist TkDone','instruccion',7,'p_instruccion_if','./SintBrainiac.py',677),
  ('instruccion -> declaracion TkExecute instlist TkDone','instruccion',4,'p_instruccion_bloque','./SintBrainiac.py',686),
  ('instruccion -> TkExecute instlist TkDone','instruccion',3,'p_instruccion_bloque','./SintBrainiac.py',687),
  ('instruccion -> TkLlaveAbre lista_tape TkLlaveCierra TkAt ident_tape','instruccion',5,'p_instruccion_b','./SintBrainiac.py',696),
  ('ident_tape -> TkCorcheteAbre exp TkCorcheteCierra','ident_tape',3,'p_ident_tape','./SintBrainiac.py',700),
  ('ident_tape -> TkIdent','ident_tape',1,'p_ident_tape','./SintBrainiac.py',701),
  ('lista_tape -> lista_tape simb_tape','lista_tape',2,'p_lista_tape','./SintBrainiac.py',710),
  ('lista_tape -> simb_tape','lista_tape',1,'p_lista_tape','./SintBrainiac.py',711),
  ('simb_tape -> TkPunto','simb_tape',1,'p_simb_tape','./SintBrainiac.py',720),
  ('simb_tape -> TkMayor','simb_tape',1,'p_simb_tape','./SintBrainiac.py',721),
  ('simb_tape -> TkMenor','simb_tape',1,'p_simb_tape','./SintBrainiac.py',722),
  ('simb_tape -> TkMas','simb_tape',1,'p_simb_tape','./SintBrainiac.py',723),
  ('simb_tape -> TkResta','simb_tape',1,'p_simb_tape','./SintBrainiac.py',724),
  ('simb_tape -> TkComa','simb_tape',1,'p_simb_tape','./SintBrainiac.py',725),
  ('instlist -> instlist semicoloninst','instlist',2,'p_instlist','./SintBrainiac.py',730),
  ('instlist -> instruccion','instlist',1,'p_instlist','./SintBrainiac.py',731),
  ('semicoloninst -> TkPuntoYComa instruccion','semicoloninst',2,'p_commainst','./SintBrainiac.py',740),
  ('declaracion -> TkDeclare declist','declaracion',2,'p_declaracion','./SintBrainiac.py',746),
  ('declist -> dec TkPuntoYComa declist','declist',3,'p_declist','./SintBrainiac.py',749),
  ('declist -> dec','declist',1,'p_declist','./SintBrainiac.py',750),
  ('dec -> varlist TkType tipo','dec',3,'p_dec','./SintBrainiac.py',753),
  ('varlist -> TkIdent TkComa varlist','varlist',3,'p_varlist','./SintBrainiac.py',756),
  ('varlist -> TkIdent','varlist',1,'p_varlist','./SintBrainiac.py',757),
  ('tipo -> TkInteger','tipo',1,'p_tipo_int','./SintBrainiac.py',760),
  ('tipo -> TkBoolean','tipo',1,'p_tipo_bool','./SintBrainiac.py',763),
  ('tipo -> TkTape','tipo',1,'p_tipo_tape','./SintBrainiac.py',766),
]
