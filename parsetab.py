...
_lr_productions = [
  ...
  ('programa -> declaracion TkExecute instlist TkDone','programa',4,'p_programa','./SintBrainiac.py',583),
  ('programa -> TkExecute instlist TkDone','programa',3,'p_programa','./SintBrainiac.py',584),
  ('term -> TkNum','term',1,'p_term_num','./SintBrainiac.py',593),
  ('term -> TkIdent','term',1,'p_term_ident','./SintBrainiac.py',601),
  ('exp_un -> TkResta exp','exp_un',2,'p_exp_un','./SintBrainiac.py',609),
  ('exp_un -> TkNegacion exp','exp_un',2,'p_exp_un','./SintBrainiac.py',610),
  ('exp_un -> TkInspeccion exp','exp_un',2,'p_exp_un','./SintBrainiac.py',611),
  ('exp -> term','exp',1,'p_exp','./SintBrainiac.py',617),
  ('exp -> exp_un','exp',1,'p_exp','./SintBrainiac.py',618),
  ('exp -> TkParAbre exp TkParCierra','exp',3,'p_exp','./SintBrainiac.py',619),
  ('exp -> TkCorcheteAbre exp TkCorcheteCierra','exp',3,'p_exp','./SintBrainiac.py',620),
  ('exp -> TkLlaveAbre exp TkLlaveCierra','exp',3,'p_exp','./SintBrainiac.py',621),
  ('exp -> exp TkMas exp','exp',3,'p_exp','./SintBrainiac.py',622),
  ('exp -> exp TkMult exp','exp',3,'p_exp','./SintBrainiac.py',623),
  ('exp -> exp TkMod exp','exp',3,'p_exp','./SintBrainiac.py',624),
  ('exp -> exp TkDiv exp','exp',3,'p_exp','./SintBrainiac.py',625),
  ('exp -> exp TkResta exp','exp',3,'p_exp','./SintBrainiac.py',626),
  ('exp -> TkTrue','exp',1,'p_exp','./SintBrainiac.py',627),
  ('exp -> TkFalse','exp',1,'p_exp','./SintBrainiac.py',628),
  ('exp -> exp TkIgual exp','exp',3,'p_exp','./SintBrainiac.py',629),
  ('exp -> exp TkDesigual exp','exp',3,'p_exp','./SintBrainiac.py',630),
  ('exp -> exp TkMenor exp','exp',3,'p_exp','./SintBrainiac.py',631),
  ('exp -> exp TkMayor exp','exp',3,'p_exp','./SintBrainiac.py',632),
  ('exp -> exp TkMenorIgual exp','exp',3,'p_exp','./SintBrainiac.py',633),
  ('exp -> exp TkMayorIgual exp','exp',3,'p_exp','./SintBrainiac.py',634),
  ('exp -> exp TkDisyuncion exp','exp',3,'p_exp','./SintBrainiac.py',635),
  ('exp -> exp TkConjuncion exp','exp',3,'p_exp','./SintBrainiac.py',636),
  ('exp -> exp TkConcat exp','exp',3,'p_exp','./SintBrainiac.py',637),
  ('instruccion -> TkIdent TkAsignacion exp','instruccion',3,'p_instruccion_asignacion','./SintBrainiac.py',649),
  ('instruccion -> TkRead exp','instruccion',2,'p_instruccion_read','./SintBrainiac.py',655),
  ('instruccion -> TkWrite exp','instruccion',2,'p_instruccion_write','./SintBrainiac.py',661),
  ('instruccion -> TkWhile exp TkDo instlist TkDone','instruccion',5,'p_instruccion_while','./SintBrainiac.py',667),
  ('instruccion -> TkFor TkIdent TkFrom exp TkTo exp TkDo instlist TkDone','instruccion',9,'p_instruccion_for','./SintBrainiac.py',673),
  ('instruccion -> TkIf exp TkThen instlist TkDone','instruccion',5,'p_instruccion_if','./SintBrainiac.py',679),
  ('instruccion -> TkIf exp TkThen instlist TkElse instlist TkDone','instruccion',7,'p_instruccion_if','./SintBrainiac.py',680),
  ('instruccion -> declaracion TkExecute instlist TkDone','instruccion',4,'p_instruccion_bloque','./SintBrainiac.py',689),
  ('instruccion -> TkExecute instlist TkDone','instruccion',3,'p_instruccion_bloque','./SintBrainiac.py',690),
  ('instruccion -> TkLlaveAbre lista_tape TkLlaveCierra TkAt ident_tape','instruccion',5,'p_instruccion_b','./SintBrainiac.py',699),
  ('ident_tape -> TkCorcheteAbre exp TkCorcheteCierra','ident_tape',3,'p_ident_tape','./SintBrainiac.py',703),
  ('ident_tape -> TkIdent','ident_tape',1,'p_ident_tape','./SintBrainiac.py',704),
  ('lista_tape -> lista_tape simb_tape','lista_tape',2,'p_lista_tape','./SintBrainiac.py',713),
  ('lista_tape -> simb_tape','lista_tape',1,'p_lista_tape','./SintBrainiac.py',714),
  ('simb_tape -> TkPunto','simb_tape',1,'p_simb_tape','./SintBrainiac.py',723),
  ('simb_tape -> TkMayor','simb_tape',1,'p_simb_tape','./SintBrainiac.py',724),
  ('simb_tape -> TkMenor','simb_tape',1,'p_simb_tape','./SintBrainiac.py',725),
  ('simb_tape -> TkMas','simb_tape',1,'p_simb_tape','./SintBrainiac.py',726),
  ('simb_tape -> TkResta','simb_tape',1,'p_simb_tape','./SintBrainiac.py',727),
  ('simb_tape -> TkComa','simb_tape',1,'p_simb_tape','./SintBrainiac.py',728),
  ('instlist -> instlist semicoloninst','instlist',2,'p_instlist','./SintBrainiac.py',733),
  ('instlist -> instruccion','instlist',1,'p_instlist','./SintBrainiac.py',734),
  ('semicoloninst -> TkPuntoYComa instruccion','semicoloninst',2,'p_commainst','./SintBrainiac.py',743),
  ('declaracion -> TkDeclare declist','declaracion',2,'p_declaracion','./SintBrainiac.py',749),
  ('declist -> dec TkPuntoYComa declist','declist',3,'p_declist','./SintBrainiac.py',752),
  ('declist -> dec','declist',1,'p_declist','./SintBrainiac.py',753),
  ('dec -> varlist TkType tipo','dec',3,'p_dec','./SintBrainiac.py',756),
  ('varlist -> TkIdent TkComa varlist','varlist',3,'p_varlist','./SintBrainiac.py',759),
  ('varlist -> TkIdent','varlist',1,'p_varlist','./SintBrainiac.py',760),
  ('tipo -> TkInteger','tipo',1,'p_tipo_int','./SintBrainiac.py',763),
  ('tipo -> TkBoolean','tipo',1,'p_tipo_bool','./SintBrainiac.py',766),
  ('tipo -> TkTape','tipo',1,'p_tipo_tape','./SintBrainiac.py',769),
]
