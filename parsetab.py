...
_lr_productions = [
  ...
  ('programa -> declaracion TkExecute instlist TkDone','programa',4,'p_programa','./SintBrainiac.py',565),
  ('programa -> TkExecute instlist TkDone','programa',3,'p_programa','./SintBrainiac.py',566),
  ('term -> TkNum','term',1,'p_term_num','./SintBrainiac.py',575),
  ('term -> TkIdent','term',1,'p_term_ident','./SintBrainiac.py',583),
  ('exp_un -> TkResta exp','exp_un',2,'p_exp_un','./SintBrainiac.py',591),
  ('exp_un -> TkNegacion exp','exp_un',2,'p_exp_un','./SintBrainiac.py',592),
  ('exp -> term','exp',1,'p_exp','./SintBrainiac.py',598),
  ('exp -> TkTrue','exp',1,'p_exp','./SintBrainiac.py',599),
  ('exp -> TkFalse','exp',1,'p_exp','./SintBrainiac.py',600),
  ('exp -> exp_un','exp',1,'p_exp','./SintBrainiac.py',601),
  ('exp -> TkParAbre exp TkParCierra','exp',3,'p_exp','./SintBrainiac.py',602),
  ('exp -> TkCorcheteAbre exp TkCorcheteCierra','exp',3,'p_exp','./SintBrainiac.py',603),
  ('exp -> TkLlaveAbre exp TkLlaveCierra','exp',3,'p_exp','./SintBrainiac.py',604),
  ('exp -> exp TkMas exp','exp',3,'p_exp','./SintBrainiac.py',605),
  ('exp -> exp TkMult exp','exp',3,'p_exp','./SintBrainiac.py',606),
  ('exp -> exp TkMod exp','exp',3,'p_exp','./SintBrainiac.py',607),
  ('exp -> exp TkDiv exp','exp',3,'p_exp','./SintBrainiac.py',608),
  ('exp -> exp TkResta exp','exp',3,'p_exp','./SintBrainiac.py',609),
  ('exp -> exp TkIgual exp','exp',3,'p_exp','./SintBrainiac.py',610),
  ('exp -> exp TkDesigual exp','exp',3,'p_exp','./SintBrainiac.py',611),
  ('exp -> exp TkMenor exp','exp',3,'p_exp','./SintBrainiac.py',612),
  ('exp -> exp TkMayor exp','exp',3,'p_exp','./SintBrainiac.py',613),
  ('exp -> exp TkMenorIgual exp','exp',3,'p_exp','./SintBrainiac.py',614),
  ('exp -> exp TkMayorIgual exp','exp',3,'p_exp','./SintBrainiac.py',615),
  ('exp -> exp TkConcat exp','exp',3,'p_exp','./SintBrainiac.py',616),
  ('exp -> exp TkInspeccion exp','exp',3,'p_exp','./SintBrainiac.py',617),
  ('exp -> exp TkDisyuncion exp','exp',3,'p_exp','./SintBrainiac.py',618),
  ('exp -> exp TkConjuncion exp','exp',3,'p_exp','./SintBrainiac.py',619),
  ('exp -> exp TkAt exp','exp',3,'p_exp','./SintBrainiac.py',620),
  ('instruccion -> TkIdent TkAsignacion exp','instruccion',3,'p_instruccion_asignacion','./SintBrainiac.py',632),
  ('instruccion -> TkRead exp','instruccion',2,'p_instruccion_read','./SintBrainiac.py',638),
  ('instruccion -> TkWrite TkCadena','instruccion',2,'p_instruccion_write','./SintBrainiac.py',644),
  ('instruccion -> TkWhile exp TkDo instruccion TkDone','instruccion',5,'p_instruccion_while','./SintBrainiac.py',666),
  ('instruccion -> TkFor TkIdent TkFrom exp TkTo exp TkDo instruccion','instruccion',8,'p_instruccion_for','./SintBrainiac.py',672),
  ('instruccion -> TkIf exp TkThen instruccion TkDone','instruccion',5,'p_instruccion_if','./SintBrainiac.py',677),
  ('instruccion -> TkIf exp TkThen instruccion TkElse instruccion TkDone','instruccion',7,'p_instruccion_if','./SintBrainiac.py',678),
  ('instruccion -> declaracion TkExecute instlist TkDone','instruccion',4,'p_instruction_bloque','./SintBrainiac.py',687),
  ('instruccion -> TkExecute instlist TkDone','instruccion',3,'p_instruction_bloque','./SintBrainiac.py',688),
  ('instlist -> instlist semicoloninst','instlist',2,'p_instlist','./SintBrainiac.py',697),
  ('instlist -> instruccion','instlist',1,'p_instlist','./SintBrainiac.py',698),
  ('semicoloninst -> TkPuntoYComa instruccion','semicoloninst',2,'p_commainst','./SintBrainiac.py',707),
  ('declaracion -> TkDeclare declist','declaracion',2,'p_declaracion','./SintBrainiac.py',713),
  ('declist -> dec TkPuntoYComa declist','declist',3,'p_declist','./SintBrainiac.py',716),
  ('declist -> dec','declist',1,'p_declist','./SintBrainiac.py',717),
  ('dec -> varlist TkType tipo','dec',3,'p_dec','./SintBrainiac.py',720),
  ('varlist -> TkIdent TkComa varlist','varlist',3,'p_varlist','./SintBrainiac.py',723),
  ('varlist -> TkIdent','varlist',1,'p_varlist','./SintBrainiac.py',724),
  ('tipo -> TkInteger','tipo',1,'p_tipo_int','./SintBrainiac.py',727),
  ('tipo -> TkBoolean','tipo',1,'p_tipo_bool','./SintBrainiac.py',730),
  ('tipo -> TkTape','tipo',1,'p_tipo_tape','./SintBrainiac.py',733),
]
