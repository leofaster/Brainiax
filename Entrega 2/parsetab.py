...
_lr_signature = '\xae\xa6?\xbe%\xa3\xbe\xa8\x08U\x17\xa7$\x18\xbb\xb6'
...
_lr_productions = [
  ...
  ('programa -> declaracion TkExecute instlist TkDone','programa',4,'p_programa','./SintBrainiac.py',296),
  ('programa -> TkExecute instlist TkDone','programa',3,'p_programa','./SintBrainiac.py',297),
  ('term -> TkNum','term',1,'p_term_num','./SintBrainiac.py',306),
  ('term -> TkIdent','term',1,'p_term_ident','./SintBrainiac.py',314),
  ('exp_un -> TkResta exp','exp_un',2,'p_exp_un','./SintBrainiac.py',322),
  ('exp_un -> TkNegacion exp','exp_un',2,'p_exp_un','./SintBrainiac.py',323),
  ('exp_un -> TkInspeccion exp','exp_un',2,'p_exp_un','./SintBrainiac.py',324),
  ('exp -> term','exp',1,'p_exp','./SintBrainiac.py',330),
  ('exp -> exp_un','exp',1,'p_exp','./SintBrainiac.py',331),
  ('exp -> TkParAbre exp TkParCierra','exp',3,'p_exp','./SintBrainiac.py',332),
  ('exp -> TkCorcheteAbre exp TkCorcheteCierra','exp',3,'p_exp','./SintBrainiac.py',333),
  ('exp -> TkLlaveAbre exp TkLlaveCierra','exp',3,'p_exp','./SintBrainiac.py',334),
  ('exp -> exp TkMas exp','exp',3,'p_exp','./SintBrainiac.py',335),
  ('exp -> exp TkMult exp','exp',3,'p_exp','./SintBrainiac.py',336),
  ('exp -> exp TkMod exp','exp',3,'p_exp','./SintBrainiac.py',337),
  ('exp -> exp TkDiv exp','exp',3,'p_exp','./SintBrainiac.py',338),
  ('exp -> exp TkResta exp','exp',3,'p_exp','./SintBrainiac.py',339),
  ('exp -> TkTrue','exp',1,'p_exp','./SintBrainiac.py',340),
  ('exp -> TkFalse','exp',1,'p_exp','./SintBrainiac.py',341),
  ('exp -> exp TkIgual exp','exp',3,'p_exp','./SintBrainiac.py',342),
  ('exp -> exp TkDesigual exp','exp',3,'p_exp','./SintBrainiac.py',343),
  ('exp -> exp TkMenor exp','exp',3,'p_exp','./SintBrainiac.py',344),
  ('exp -> exp TkMayor exp','exp',3,'p_exp','./SintBrainiac.py',345),
  ('exp -> exp TkMenorIgual exp','exp',3,'p_exp','./SintBrainiac.py',346),
  ('exp -> exp TkMayorIgual exp','exp',3,'p_exp','./SintBrainiac.py',347),
  ('exp -> exp TkDisyuncion exp','exp',3,'p_exp','./SintBrainiac.py',348),
  ('exp -> exp TkConjuncion exp','exp',3,'p_exp','./SintBrainiac.py',349),
  ('exp -> exp TkConcat exp','exp',3,'p_exp','./SintBrainiac.py',350),
  ('instruccion -> TkIdent TkAsignacion exp','instruccion',3,'p_instruccion_asignacion','./SintBrainiac.py',362),
  ('instruccion -> TkRead exp','instruccion',2,'p_instruccion_read','./SintBrainiac.py',368),
  ('instruccion -> TkWrite exp','instruccion',2,'p_instruccion_write','./SintBrainiac.py',374),
  ('instruccion -> TkWhile exp TkDo instlist TkDone','instruccion',5,'p_instruccion_while','./SintBrainiac.py',380),
  ('instruccion -> TkFor TkIdent TkFrom exp TkTo exp TkDo instlist TkDone','instruccion',9,'p_instruccion_for','./SintBrainiac.py',386),
  ('instruccion -> TkIf exp TkThen instlist TkDone','instruccion',5,'p_instruccion_if','./SintBrainiac.py',391),
  ('instruccion -> TkIf exp TkThen instlist TkElse instlist TkDone','instruccion',7,'p_instruccion_if','./SintBrainiac.py',392),
  ('instruccion -> declaracion TkExecute instlist TkDone','instruccion',4,'p_instruccion_bloque','./SintBrainiac.py',401),
  ('instruccion -> TkExecute instlist TkDone','instruccion',3,'p_instruccion_bloque','./SintBrainiac.py',402),
  ('instruccion -> TkLlaveAbre lista_tape TkLlaveCierra TkAt ident_tape','instruccion',5,'p_instruccion_b','./SintBrainiac.py',411),
  ('ident_tape -> TkCorcheteAbre exp TkCorcheteCierra','ident_tape',3,'p_ident_tape','./SintBrainiac.py',415),
  ('ident_tape -> TkIdent','ident_tape',1,'p_ident_tape','./SintBrainiac.py',416),
  ('lista_tape -> lista_tape simb_tape','lista_tape',2,'p_lista_tape','./SintBrainiac.py',425),
  ('lista_tape -> simb_tape','lista_tape',1,'p_lista_tape','./SintBrainiac.py',426),
  ('simb_tape -> TkPunto','simb_tape',1,'p_simb_tape','./SintBrainiac.py',435),
  ('simb_tape -> TkMayor','simb_tape',1,'p_simb_tape','./SintBrainiac.py',436),
  ('simb_tape -> TkMenor','simb_tape',1,'p_simb_tape','./SintBrainiac.py',437),
  ('simb_tape -> TkMas','simb_tape',1,'p_simb_tape','./SintBrainiac.py',438),
  ('simb_tape -> TkResta','simb_tape',1,'p_simb_tape','./SintBrainiac.py',439),
  ('simb_tape -> TkComa','simb_tape',1,'p_simb_tape','./SintBrainiac.py',440),
  ('instlist -> instlist semicoloninst','instlist',2,'p_instlist','./SintBrainiac.py',446),
  ('instlist -> instruccion','instlist',1,'p_instlist','./SintBrainiac.py',447),
  ('semicoloninst -> TkPuntoYComa instruccion','semicoloninst',2,'p_commainst','./SintBrainiac.py',456),
  ('declaracion -> TkDeclare declist','declaracion',2,'p_declaracion','./SintBrainiac.py',462),
  ('declist -> dec TkPuntoYComa declist','declist',3,'p_declist','./SintBrainiac.py',465),
  ('declist -> dec','declist',1,'p_declist','./SintBrainiac.py',466),
  ('dec -> varlist TkType tipo','dec',3,'p_dec','./SintBrainiac.py',469),
  ('varlist -> TkIdent TkComa varlist','varlist',3,'p_varlist','./SintBrainiac.py',472),
  ('varlist -> TkIdent','varlist',1,'p_varlist','./SintBrainiac.py',473),
  ('tipo -> TkInteger','tipo',1,'p_tipo_int','./SintBrainiac.py',476),
  ('tipo -> TkBoolean','tipo',1,'p_tipo_bool','./SintBrainiac.py',479),
  ('tipo -> TkTape','tipo',1,'p_tipo_tape','./SintBrainiac.py',482),
]
