...
_lr_productions = [
  ...
  ('programa -> declaracion TkExecute instlist TkDone','programa',4,'p_programa','./sintbrainiax.py',300),
  ('programa -> TkExecute instlist TkDone','programa',3,'p_programa','./sintbrainiax.py',301),
  ('term -> TkNum','term',1,'p_term_num','./sintbrainiax.py',310),
  ('term -> TkIdent','term',1,'p_term_ident','./sintbrainiax.py',318),
  ('exp_un -> TkResta exp','exp_un',2,'p_exp_un','./sintbrainiax.py',326),
  ('exp_un -> TkNegacion exp','exp_un',2,'p_exp_un','./sintbrainiax.py',327),
  ('exp -> term','exp',1,'p_exp','./sintbrainiax.py',333),
  ('exp -> TkTrue','exp',1,'p_exp','./sintbrainiax.py',334),
  ('exp -> TkFalse','exp',1,'p_exp','./sintbrainiax.py',335),
  ('exp -> exp_un','exp',1,'p_exp','./sintbrainiax.py',336),
  ('exp -> TkParAbre exp TkParCierra','exp',3,'p_exp','./sintbrainiax.py',337),
  ('exp -> TkCorcheteAbre exp TkCorcheteCierra','exp',3,'p_exp','./sintbrainiax.py',338),
  ('exp -> TkLlaveAbre exp TkLlaveCierra','exp',3,'p_exp','./sintbrainiax.py',339),
  ('exp -> exp TkMas exp','exp',3,'p_exp','./sintbrainiax.py',340),
  ('exp -> exp TkMult exp','exp',3,'p_exp','./sintbrainiax.py',341),
  ('exp -> exp TkMod exp','exp',3,'p_exp','./sintbrainiax.py',342),
  ('exp -> exp TkDiv exp','exp',3,'p_exp','./sintbrainiax.py',343),
  ('exp -> exp TkResta exp','exp',3,'p_exp','./sintbrainiax.py',344),
  ('exp -> exp TkIgual exp','exp',3,'p_exp','./sintbrainiax.py',345),
  ('exp -> exp TkDesigual exp','exp',3,'p_exp','./sintbrainiax.py',346),
  ('exp -> exp TkMenor exp','exp',3,'p_exp','./sintbrainiax.py',347),
  ('exp -> exp TkMayor exp','exp',3,'p_exp','./sintbrainiax.py',348),
  ('exp -> exp TkMenorIgual exp','exp',3,'p_exp','./sintbrainiax.py',349),
  ('exp -> exp TkMayorIgual exp','exp',3,'p_exp','./sintbrainiax.py',350),
  ('exp -> exp TkConcat exp','exp',3,'p_exp','./sintbrainiax.py',351),
  ('exp -> exp TkInspeccion exp','exp',3,'p_exp','./sintbrainiax.py',352),
  ('exp -> exp TkDisyuncion exp','exp',3,'p_exp','./sintbrainiax.py',353),
  ('exp -> exp TkConjuncion exp','exp',3,'p_exp','./sintbrainiax.py',354),
  ('exp -> exp TkAt exp','exp',3,'p_exp','./sintbrainiax.py',355),
  ('instruccion -> TkIdent TkAsignacion exp','instruccion',3,'p_instruccion_asignacion','./sintbrainiax.py',367),
  ('instruccion -> TkRead exp','instruccion',2,'p_instruccion_read','./sintbrainiax.py',373),
  ('instruccion -> TkWrite exp','instruccion',2,'p_instruccion_write','./sintbrainiax.py',379),
  ('instruccion -> TkWhile exp TkDo instlist TkDone','instruccion',5,'p_instruccion_while','./sintbrainiax.py',385),
  ('instruccion -> TkFor TkIdent TkFrom exp TkTo exp TkDo instlist TkDone','instruccion',9,'p_instruccion_for','./sintbrainiax.py',391),
  ('instruccion -> TkIf exp TkThen instlist TkDone','instruccion',5,'p_instruccion_if','./sintbrainiax.py',396),
  ('instruccion -> TkIf exp TkThen instlist TkElse instlist TkDone','instruccion',7,'p_instruccion_if','./sintbrainiax.py',397),
  ('instruccion -> declaracion TkExecute instlist TkDone','instruccion',4,'p_instruccion_bloque','./sintbrainiax.py',406),
  ('instruccion -> TkExecute instlist TkDone','instruccion',3,'p_instruccion_bloque','./sintbrainiax.py',407),
  ('instlist -> instlist semicoloninst','instlist',2,'p_instlist','./sintbrainiax.py',416),
  ('instlist -> instruccion','instlist',1,'p_instlist','./sintbrainiax.py',417),
  ('semicoloninst -> TkPuntoYComa instruccion','semicoloninst',2,'p_commainst','./sintbrainiax.py',426),
  ('declaracion -> TkDeclare declist','declaracion',2,'p_declaracion','./sintbrainiax.py',432),
  ('declist -> dec TkPuntoYComa declist','declist',3,'p_declist','./sintbrainiax.py',435),
  ('declist -> dec','declist',1,'p_declist','./sintbrainiax.py',436),
  ('dec -> varlist TkType tipo','dec',3,'p_dec','./sintbrainiax.py',439),
  ('varlist -> TkIdent TkComa varlist','varlist',3,'p_varlist','./sintbrainiax.py',442),
  ('varlist -> TkIdent','varlist',1,'p_varlist','./sintbrainiax.py',443),
  ('tipo -> TkInteger','tipo',1,'p_tipo_int','./sintbrainiax.py',446),
  ('tipo -> TkBoolean','tipo',1,'p_tipo_bool','./sintbrainiax.py',449),
  ('tipo -> TkTape','tipo',1,'p_tipo_tape','./sintbrainiax.py',452),
]
